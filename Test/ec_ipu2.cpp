...
int main(int argc, char* argv[]) {
    ...
    // uint8_t g_tbls[32 * data_num * parity_num];

    encode_matrix = (uint8_t*)malloc(data_num * (data_num + parity_num));
    g_tbls = (uint8_t*)malloc(32 * data_num * parity_num);
